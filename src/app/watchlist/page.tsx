...
export default function WatchlistPage() {
  // All your original state and logic remains here
  ...
  // ===== All your original useEffects and functions (Auth, loadItems, etc.) go here =====
  useEffect(() => {
    let cancelled = false;
  ...
  // ===== New Render method with our styled components =====
